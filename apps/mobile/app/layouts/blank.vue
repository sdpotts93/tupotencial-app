  ...
  <div class="blank-layout">
    ...
    <header class="blank-layout__topbar">
      ...
      <div class="blank-layout__topbar-right">
        <NuxtLink to="/cuenta/hoy/progreso" class="blank-layout__streak">
          <Icon name="lucide:flame" size="14" class="blank-layout__streak-icon" />
          <span>{{ streak }}</span>
        </NuxtLink>
        <div class="blank-layout__avatar" @click="navigateTo('/cuenta/mis-datos')">
          {{ initials }}
        </div>
      </div>
    </header>
...
const { data: streakData } = await useAsyncData('blank-layout-streak', async () => {

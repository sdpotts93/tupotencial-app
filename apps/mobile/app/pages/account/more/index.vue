<template>
  <div class="screen">
    <div class="screen__content">
      ...
      <UiList>
        <UiListItem label="VIP" description="Mentorías, retiros y experiencias premium" to="/account/addons">
          <template #icon>
        ...
        <UiListItem label="Beneficios" description="Alianzas y descuentos exclusivos para miembros" to="/account/benefits">
          <template #icon>
      ...
      <UiList>
        <UiListItem label="Mi Coach IA" description="Tu coach personal con inteligencia artificial" to="/account/ai">
          <template #icon>
        ...
        <UiListItem label="Mi Progreso" description="Racha, estadísticas y logros" to="/account/hoy/progress">
          <template #icon>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
          </template>
        </UiListItem>
        <UiListItem label="Mi perfil" description="Edita tu nombre, foto y segmento" to="/account/profile">
          <template #icon>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
          </template>
        </UiListItem>
        <UiListItem label="Configuración" description="Notificaciones y preferencias" to="/account/settings">
          <template #icon>

  ...
  <div class="screen">
    <div class="detail">
      ...
      <div class="detail__media">
        ...
        <button class="detail__play-btn" aria-label="Reproducir" @click="navigateTo(`/account/content/${id}/play`)">
      ...
      <div class="detail__info">
        ...
        <div class="detail__actions">
          <UiButton variant="outline" block @click="navigateTo(`/account/content/${id}/play`)">

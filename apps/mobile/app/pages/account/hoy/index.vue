    ...
    <div class="hoy__hero-row">
      <div class="hoy__hero">
        <div class="hoy__hero-top">
          ...
          <NuxtLink to="/account/hoy/progress" class="hoy__streak-badge">
      ...
      <NuxtLink to="/account/hoy/progress" :class="['hoy__hero-progress', { 'hoy__hero-progress--complete': allRetosComplete }]">
    ...
    <div class="screen__content">
      ...
      <section :class="['hoy__retos', { 'hoy__retos--complete': allRetosComplete }]">
        <Transition name="fade" mode="out-in">
          ...
          <NuxtLink v-if="allRetosComplete" key="complete" to="/account/hoy/progress" class="hoy__celebration">
      ...
      <section class="hoy__latest">
        <div class="hoy__latest-header">
          ...
          <NuxtLink to="/account/library" class="hoy__latest-see-all">Ver todo</NuxtLink>
        </div>
...
const latestContent = ref([
  {
    ...
    duration: '10 min',
    to: '/account/library/mock-uuid-ci-001',
  },
  {
    id: 'mock-uuid-ci-002',
    type: 'video' as const,
    ...
    duration: '5 min',
    to: '/account/library/mock-uuid-ci-002',
  },
  {
    id: 'mock-uuid-ci-003',
    type: 'video' as const,
    ...
    duration: '8 min',
    to: '/account/library/mock-uuid-ci-003',
  },
])

      ...
      <template v-else>
        ...
        <template v-if="activeTab === 'categorias'">
          ...
          <section class="library__featured">
            ...
            <NuxtLink to="/account/content/mock-content-001" class="library__featured-card">
          ...
          <section v-for="cat in categories" :key="cat.slug" class="library__section">
            <div class="section__header">
              ...
              <NuxtLink :to="`/account/library/c/${cat.slug}`" class="library__see-all">Ver todo</NuxtLink>
            </div>
          ...
          <section class="library__section">
            <div class="section__header">
              ...
              <NuxtLink to="/account/events" class="library__see-all">Ver todo</NuxtLink>
            </div>
            <div class="library__scroll">
              <NuxtLink
                v-for="ev in recordedEvents"
                :key="ev.id"
                :to="`/account/events/${ev.id}`"
                class="library__scroll-card"
              >
        ...
        <template v-if="activeTab === 'programas'">
          ...
          <section v-for="prog in programsWithContent" :key="prog.id" class="library__section">
            <div class="section__header">
              ...
              <NuxtLink :to="`/account/retos/${prog.id}`" class="library__see-all">Ver programa</NuxtLink>
            </div>
            <div class="library__scroll">
              <NuxtLink

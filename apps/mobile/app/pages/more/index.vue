<template>
  <div class="screen">
    <div class="screen__content">
      ...
      <UiList>
        <UiListItem label="VIP" description="Mentorías, retiros y experiencias premium" to="/addons">
          <template #icon>
...
.more__info :deep(.tag--accent) { width: fit-content; background: rgba(212, 175, 55, 0.15); color: #D4AF37; }
